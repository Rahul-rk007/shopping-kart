                        ...
                        <div className="col-12 col-md-6 col-lg-4">
                            <div className="shipping-method-area mt-70">
                                ...
                                <div className="custom-control custom-radio mb-30">
                                    ...
                                    <label className="custom-control-label d-flex align-items-center justify-content-between" htmlFor="customRadio1">
                                ...
                                <div className="custom-control custom-radio">
                                    ...
                                    <label className="custom-control-label d-flex align-items-center justify-content-between" htmlFor="customRadio3">
